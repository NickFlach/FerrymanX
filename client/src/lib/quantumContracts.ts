...
export const BRIDGE_VAULT_ABI = [
  ...
  "function requestExit(address asset, uint256 amount) returns (uint256)",
  ...
  "function getExitRequest(uint256 exitId) view returns (tuple(address user, address asset, uint256 amount, uint256 requestBlock, uint256 unlockBlock, bool completed, bool isPriority))",
